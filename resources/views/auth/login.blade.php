...
<!-- Mirrored from techzaa.in/velonic/layouts/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 May 2026 12:22:29 GMT -->
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="checkbox-signin remember" name="remember"
                                                        {{ old('remember') ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="checkbox-signin">{{ __('Remember Me') }}</label>
                                                </div>
                                            </div>
                                            <div class="mb-0 text-start">
                                                <button class="btn btn-soft-primary w-100" ><i
                                                        class="ri-login-circle-fill me-1"></i> <span class="fw-bold">
                                                        </span> 
                                                    {{ __('Login') }}
                                                    </button>
