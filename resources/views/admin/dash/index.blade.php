        ...
        <div class="row">
            <div class="col-xxl-3 col-sm-6">
                <div class="card widget-flat text-bg-pink">
                    <div class="card-body">
                        <div class="float-end">
                            <i class=" ri-hotel-bed-line widget-icon"></i>
                        </div>
                        <h6 class="text-uppercase mt-0" title="Customers">Quartos</h6>
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card widget-flat text-bg-purple">
                    <div class="card-body">
                        <div class="float-end">
                            <i class=" ri-bookmark-2-line widget-icon"></i>
                        </div>
                        <h6 class="text-uppercase mt-0" title="Customers">Quartos Reservados</h6>
                        <h2 class="my-2">{{$bookings}}</h2>
                        <p class="mb-0">
                            <span class="badge bg-white bg-opacity-10 me-1"></span>
                            <span class="text-nowrap"></span>
                        </p>
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card widget-flat text-bg-info">
                    <div class="card-body">
                        <div class="float-end">
                            <i class=" ri-home-line widget-icon"></i>
                        </div>
                        <h6 class="text-uppercase mt-0" title="Customers">Quartos Disponíveis</h6>
                        <h2 class="my-2">{{$roomAvailabe}}</h2>
                        <p class="mb-0">
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card widget-flat text-bg-primary">
                    <div class="card-body">
                        ...
                        <h6 class="text-uppercase mt-0" title="Customers">Clientes</h6>
